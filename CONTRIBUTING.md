...
Clone the project on [GitHub](git@github.com:Green-Software-Foundation/if-unofficial-plugins.git)

```bash
$ git clone git@github.com:Green-Software-Foundation/if-unofficial-plugins.git
